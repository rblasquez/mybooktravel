                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-weight:bold; font-family: 'Montserrat', sans-serif;" align="center">
                                                <h4>
                                                    <span style="font-size:20px; text-transform:uppercase; color:#0EC5D8 !important;">Hola {{ $anfitrion->nombres }}</span>
                                                </h4>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td class="font_fix" style="font-size:16px; mso-line-height-rule:exactly; line-height:20px; color:#555555; font-family: 'Montserrat', sans-serif;" align="center">
                                                <small style="display:block; color: #555">
                                                    {{ $huesped->nombres }} esta interesado en tu propiedad, y quiere saber si esta disponible. por favor ingresa al siguiente enlace y verifica la información, luego confirma si esta disponible.
                                                </small>
                                            </td>
                                        </tr>
												...
												<table cellspacing="0" cellpadding="0" border="0" align="center">
													<tbody>
														<tr>
															...
															<a href="{!! route('reserva.listado', $propiedad->id) !!}" style="padding: 16px 31px;background: #0ec8db;color: #fff;font-size: 17px; text-decoration: none;">Verificar reserva</a>
														</td>
														</tr>
													</tbody>
